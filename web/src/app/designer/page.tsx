...
type OverviewData = { counts: { clients: number; draftProgrammes: number; adherence: number | null }; clients: Array<{ id: string; firstName: string; lastName: string; updatedAt: string }>; programmes: Array<{ id: string; clientId: string; name: string; status: string; currentWeek: number; durationWeeks: number }> };
