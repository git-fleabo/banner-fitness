...
export function SessionEditorModal({ clientName, goal, days, week, savedSessions, onClose, notify }: { clientName: string; goal: string; days: number; week: EditorExercise[]; savedSessions?: SavedSession[]; onClose: () => void; notify: (message: string) => void }) {
