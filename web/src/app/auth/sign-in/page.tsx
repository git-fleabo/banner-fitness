  ...
  return (
    <main className={styles.page}>
      <section className={styles.card} aria-labelledby="sign-in-heading">
        ...
        <p className={styles.intro}>Enter the email address matching your invitation. We will send a one-time sign-in link; no password or Google account is required.</p>
        <SignInForm />
