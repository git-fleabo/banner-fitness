  ...
  lessons: [
    {
      ...
      objects: [
        object("anatomical-position-hook", "hook", "Whose left side?", "Use the subject's viewpoint before naming a body side.", "learning-plan"),
        object("anatomical-position-explain", "explain", "A shared reference", "Anatomical position gives trainers a stable reference; directional terms compare one structure with another.", "module-1", { supportingOutcomes: ["Recognise anatomical position.", "Use subject-relative left and right.", "Apply five paired directional terms.", "Distinguish position from movement."] }),
        object("anatomical-position-explore", "explore", "Reference-position lab", "Toggle front and back views, then identify the features of anatomical position.", "learning-plan", { interaction: { name: "Reference-position lab", instructions: "Select each feature that belongs to anatomical position.", keyboardAlternative: "Use Tab to reach each labelled feature and Space or Enter to select it.", structuredText: "The subject stands upright, faces forward, keeps the arms by the sides and presents the palms forward. Left and right always belong to the subject." }, misconceptionCodes: ["VIEWER_LEFT_RIGHT"] }),
        object("anatomical-position-apply", "apply", "Complete the comparison", "Complete five landmark comparisons, then compare the same structures in the starting squat stance.", "learning-plan", { interaction: { name: "Directional comparison builder", instructions: "Choose the term that accurately completes each relationship.", keyboardAlternative: "Choose from labelled native buttons; no dragging is required.", structuredText: "Each prompt names two structures and the reference relationship used to compare them." } }),
        object("anatomical-position-check", "check", "Check your reference", "Retrieve the viewpoint and directional-term rules with immediate explanatory feedback.", "learning-plan", { questions: anatomicalPositionQuestions, misconceptionCodes: ["VIEWER_LEFT_RIGHT", "PROXIMAL_MEANS_HIGHER"] }),
        object("anatomical-position-close", "close", "Describe before you move", "You can now anchor a body description before analysing movement.", "learning-plan"),
      ],
    },
    {
      ...
      objects: [
        object("planes-hook", "hook", "Place the plane", "Predict which plane best represents the principal movement in a squat. This prediction is unscored.", "learning-plan"),
        object("planes-explain", "explain", "Plane through, axis around", "A movement occurs through a plane and rotates around an axis at right angles to that plane.", "module-1", { supportingOutcomes: ["Describe each body division.", "Pair all three planes and axes.", "Distinguish plane from axis.", "Identify the squat as predominantly sagittal."] }),
        object("planes-explore", "explore", "Plane-and-axis explorer", "Show one plane and its perpendicular axis at a time on an original neutral figure.", "learning-plan", { interaction: { name: "Plane-and-axis explorer", instructions: "Select sagittal, frontal or transverse to update the diagram and explanation.", keyboardAlternative: "Use Tab and Enter to operate three pressed-state buttons.", structuredText: "Sagittal pairs with medio-lateral; frontal with anterior-posterior; transverse with longitudinal." }, misconceptionCodes: ["PLANE_EQUALS_AXIS"] }),
        object("planes-apply", "apply", "Predominant plane sorter", "Classify a squat, lateral raise and standing torso rotation by predominant plane.", "learning-plan", { interaction: { name: "Predominant plane sorter", instructions: "Choose the best predominant plane for each movement.", keyboardAlternative: "Use labelled choice buttons as the complete alternative to drag-and-drop.", structuredText: "Squat: sagittal. Lateral raise: frontal. Standing torso rotation: transverse. Real movements may include smaller components in other planes." } }),
        object("planes-check", "check", "Check the relationships", "Retrieve plane, axis and division relationships.", "learning-plan", { questions: planeQuestions, misconceptionCodes: ["PLANE_EQUALS_AXIS"] }),
        object("planes-close", "close", "Use predominantly", "You can pair the three planes and axes without treating exercise movement as perfectly single-plane.", "learning-plan"),
      ],
    },
    {
