...
export type SavedSession = { dayOfWeek: number; name: string; scheduledTime?: string | null; managementMode?: "pt_managed" | "self_managed"; exercises: EditorExercise[] };
export type ProgrammeTemplateDefinition = { id: string; label: string; description: string; goal: string; sessionDurationMinutes?: number; experienceLevel?: string; frameworkType?: string; difficultyLevel?: 1 | 2 | 3; variantGroup?: string; sessions: Array<{ name: string; exercises: EditorExercise[] }> };
