...
description: Format The Factory PT review and programme-generation responses from a client and programme bundle, including screening context, quality findings, evidence-aware programming, missing information and copy-ready session prescriptions. Use when the AI receives The Factory's PT prompt or is asked to draft or review a programme for a client.
---

# The Factory PT Prompt

Use this skill to turn a The Factory client/programme bundle into a concise, explainable response that a qualified PT can review and apply in the programme editor.
...
- Never imply that the programme has been saved, approved or assigned. The PT must apply and approve the final result in The Factory.
...
- Evidence/ruleset supplied by The Factory: [version/date if present]
...
For a new draft, or when proposing replacement work, use one row per exercise and group rows by week and scheduled day. Use the field vocabulary The Factory can represent:
...
## Maintain this skill with The Factory
...
- The Factory's professional-scope boundaries or the supported AI response format
...
Keep the skill as the maintained contract between The Factory's PT prompt and the preferred AI tool. Do not wait for a separate user request when a relevant app change is made.
